...
router.post("/place_detail", async (req, res) => {
    try {
        ...
        const fields = ["formatted_address", "formatted_phone_number", "international_phone_number", "opening_hours", "url", "website", "rating", "reviews", "geometry"];        const fieldsParams = fields.join(",");
